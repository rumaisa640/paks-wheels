 ...
 const Alto : React.FC  = () => {
  return (
    ...
    <div className='h-screen flex flex-col justify-center items-center  bg-gray-200'>
        <h1 className='text-4xl font-bold underline capitalize pb-10'> alto 2024 price in pakistan , images,reviews and specs</h1>
    <div>
            <Image src="/red.png" width="370" height="370" alt=''></Image>
        </div>
        <div className='p-5'>
        ...
        <div>
            <h1 className='text-[#78d07b] m-9 font-bold text-2xl'>PKR 30,00,000</h1>
        </div>
